...
import { FaSearch, FaCheckCircle, FaClock, FaCalendar, FaTimes } from 'react-icons/fa';
...
const TrackBooking = () => {
  ...
  const handleSearch = (e) => {
    ...
    setTimeout(() => {
      const bookings = localStorage.getItem('walkerBookings');
      if (bookings) {
        const allBookings = JSON.parse(bookings);
        const found = allBookings.find(b => 
          b.phone === phone || (bookingId && b.id === parseInt(bookingId))
        );
  ...
  const getStatusIcon = (status) => {
    switch(status) {
      ...
      case 'fulfilled': return <FaCheckCircle />;
      case 'postponed': return <FaCalendar />;
    ...
    <div style={styles.container}>
      ...
      <div style={styles.content}>
        <div style={styles.card}>
          ...
          <p style={styles.subtitle}>Enter your phone number or booking ID to check status</p>
            ...
            <div style={styles.resultCard}>
              ...
              <div style={styles.infoGrid}>
                ...
                <div style={styles.infoRow}>
                  ...
                  <span style={styles.value}>{result.serviceOrPackage}</span>
                </div>
                <div style={styles.infoRow}>
          ...
          {result && result.notFound && (
            <div style={styles.resultCard}>
              <div style={styles.notFound}>
                ...
                <p>Please check your phone number or booking ID and try again.</p>
              </div>
            </div>
          )}
        </div>
